...
/**
 * Postal reported the "MessageDeliveryFailed" delivery status for a message.
 */
class PostalMessageDeliveryFailed extends PostalEvent
{
    ...
    {
        return WebhookEventType::MessageDeliveryFailed;
    }
}
